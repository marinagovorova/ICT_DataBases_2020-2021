...
10. Сделать пул-реквест в мой репозиторий из вашего форкнутого, описать его адекватно. Имя пулреквеста задаетсят по шаблону: Группа_Фамилия_Имя_ЛР№. Например: K3240_Иванов_Василий_ЛР2
